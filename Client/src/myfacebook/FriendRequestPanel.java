...
public class FriendRequestPanel extends javax.swing.JPanel {
    ...
    public FriendRequestPanel(JFrame parent, MainFrame mainFrame, CommModule commModule, ArrayList userArray) {
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FriendRequestPanel.class);
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel1, jLabel3, jLabel4, jLabel5, jLabel6, jLabel8});
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String response = commModule.getServantStub().acceptIgnoreFriend(mainFrame.getUserID(), friendID, 2);
            JOptionPane.showMessageDialog(this, response, "Message", JOptionPane.INFORMATION_MESSAGE);
        } catch (RemoteException ex) {
            Logger.getLogger(FriendRequestPanel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            String response = commModule.getServantStub().acceptIgnoreFriend(mainFrame.getUserID(), friendID, 1);
            JOptionPane.showMessageDialog(this, response, "Message", JOptionPane.INFORMATION_MESSAGE);

            // update friend list
            // update is done from notification
